...
class DDPG(BaseAgent):
    ...
    def store_weights(self):
        """Stores weights in given file name in the log folder"""
        actwghtsfile = os.path.join(util.get_param ('out'),"actor_weights_combined.h5")
        actwghtsfiletwo = os.path.join(util.get_param ('out'),"save_actor_weights_combined.h5")
        actorweightsjsonfile = os.path.join(util.get_param ('out'),"actor_weights_combined.json")
        critwghtsfile = os.path.join(util.get_param ('out'),"critic_weights_combined.h5")
        critwghtsfiletwo = os.path.join(util.get_param ('out'),"save_critic_weights_combined.h5")
        criticweightsjsonfile = os.path.join(util.get_param ('out'),"critic_weights_combined.json")
